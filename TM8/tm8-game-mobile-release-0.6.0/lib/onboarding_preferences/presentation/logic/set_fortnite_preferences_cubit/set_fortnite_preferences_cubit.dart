...
part 'set_fortnite_preferences_state.dart';
part 'set_fortnite_preferences_cubit.freezed.dart';

@injectable
class SetFortnitePreferencesCubit extends Cubit<SetFortnitePreferencesState> {
  SetFortnitePreferencesCubit()
      : super(const SetFortnitePreferencesState.initial());

  Future<void> setFortnitePreferences({
    ...
    try {
      emit(const SetFortnitePreferencesState.loading());

      var body = const SetFortnitePreferencesInput(
        playingLevel: '',
        agression: 3,
        teamWork: 3,
        gameplayStyle: 3,
      ...
      final result = await api.apiV1UsersPreferencesFortnitePatch(
        body: body,
      );

      emit(
        SetFortnitePreferencesState.loaded(
      ...
      logError(e.toString());
      emit(
        SetFortnitePreferencesState.error(
          error: e.toString(),
        ),
      );
    }
