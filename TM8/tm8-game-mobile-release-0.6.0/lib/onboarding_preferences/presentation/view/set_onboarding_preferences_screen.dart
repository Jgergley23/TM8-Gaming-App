...
@RoutePage() //SetOnboardingPreferencesRoute.page
class SetOnboardingPreferencesScreen extends StatefulWidget {
  const SetOnboardingPreferencesScreen({
    super.key,
  ...
  @override
  State<SetOnboardingPreferencesScreen> createState() =>
      _SetOnboardingPreferencesScreenState();
}

class _SetOnboardingPreferencesScreenState
    extends State<SetOnboardingPreferencesScreen> {
